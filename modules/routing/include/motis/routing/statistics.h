...
struct statistics {
  ...
  uint64_t labels_created_until_opt_reproduction_{};
  ...
  // not including time as this depends on the time lower bounds
  uint64_t lb_price_accuracy_raw_{};
  ...
  friend flatbuffers::Offset<Statistics> to_fbs(
    ...
    add_entry("labels_created_until_opt_reproduction",
              s.labels_created_until_opt_reproduction_);
    ...
    add_entry("optimals_max_size", s.optimals_max_size_);
    ...
    return stats_category{
        ...
        {{"labels_created", s.labels_created_},
         ...
         {"labels_created_until_first_non_opt_result",
          s.labels_created_until_first_non_opt_result_},
         {"labels_created_until_opt_reproduction",
          s.labels_created_until_opt_reproduction_},
         ...
         {"optimals_max_size", s.optimals_max_size_},
