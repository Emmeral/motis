...
public:
  lower_bounds_optimality_delegate(
      ...
      std::unique_ptr<BoundsDelegate> bounds_delegate,
      std::unique_ptr<OptimalityDelegate> optimality_delegate)
...
private:
  std::unique_ptr<BoundsDelegate> bounds_delegate_;
  std::unique_ptr<OptimalityDelegate> optimality_delegate_;
};
